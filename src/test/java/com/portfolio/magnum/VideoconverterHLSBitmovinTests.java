...
@SpringBootTest
public class VideoconverterHLSBitmovinTests {
	...
	private static final CloudRegion CLOUD_REGION = CloudRegion.AWS_US_EAST_1;
	private static String OUTPUT_BASE_PATH = "output/"+S3_INPUT_PATH+"/" + new Date().getTime();
